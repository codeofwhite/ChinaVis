<template>
  <div class="beihai-sayings-wrapper">
    <h2>北海金句录</h2>
...
import { BeihaiSayings } from './BeihaiParkSayingsData.js';
...
const palaceSayings = shallowRef(BeihaiSayings);
...
.beihai-sayings-wrapper h2::after {
  content: "";
  position: absolute;
  bottom: 0;
  left: 50%;
