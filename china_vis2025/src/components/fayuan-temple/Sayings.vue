...
import { FaYuanTempleSayings } from './fayuanSayingsData.js';
...
const palaceSayings = shallowRef(FaYuanTempleSayings);
...
.tiantan-sayings-wrapper {
  background: linear-gradient(to bottom, #f7f3eb 0%, #e9e2d5 100%);
  padding: 2.5rem 1.5rem;
  width: 100%;
  max-width: 1200px;
  margin: 2rem auto;
  border-radius: 16px;
  box-shadow: 0 12px 30px rgba(105, 74, 62, 0.15);
...
.tiantan-sayings-wrapper::before {
  ...
  right: 0;
  height: 5px;
  background: linear-gradient(to right, #694a3e, #a67c52, #694a3e);
  z-index: 1;
}
...
.tiantan-sayings-wrapper h2::after {
  ...
  width: 120px;
  height: 3px;
  background: linear-gradient(to right, #a67c52, #694a3e, #a67c52);
  border-radius: 3px;
}
...
.sayings-wordcloud-container {
  ...
  border-radius: 12px;
  box-shadow: 0 6px 20px rgba(105, 74, 62, 0.1);
  border: 1px solid #c8b6a6;
  position: relative;
  overflow: hidden;
...
.sayings-wordcloud-container:hover {
  box-shadow: 0 8px 25px rgba(105, 74, 62, 0.2);
...
.spinner {
  width: 60px;
  height: 60px;
  border: 5px solid rgba(105, 74, 62, 0.2);
  border-top: 5px solid #694a3e;
  border-radius: 50%;
...
.modal-story-content {
  ...
  border-radius: 8px;
  padding: 25px;
  box-shadow: inset 0 0 10px rgba(105, 74, 62, 0.1);
}
